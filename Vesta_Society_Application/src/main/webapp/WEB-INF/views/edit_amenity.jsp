...
<body>
    ...
    <div class="main-content">
        <h3 class="mb-4 text-center">Edit Amenity</h3>
        ...
        <form action="AmenityServlet" method="post" class="form-container">
            ...
            <div class="mb-3">
                ...
                <input type="number" name="societyId" class="form-control" value="${amenity.societyId}" required />
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" name="amount" class="form-control" value="${amenity.amount}" required />
            </div>

            <!-- Booking Required -->
            <div class="form-check mb-4">
                <input class="form-check-input" type="checkbox" name="bookingRequired" value="1" id="bookingCheck"
                       <c:if test="${amenity.bookingRequired}">checked</c:if>>
