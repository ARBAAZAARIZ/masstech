...
<body>
    ...
    <div class="main-content">
        <h3 class="mb-4 text-center">Add New Parking Slot</h3>
        ...
        <form action="ParkingSlotServlet" method="post" class="form-container">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="identifier" class="form-control" placeholder="e.g. P1, B2-Covered" required />
            </div>
            ...
            <div class="d-flex justify-content-center">
                <button type="submit" class="btn btn-success me-3">
                    <i class="bi bi-check-circle me-1"></i> Create Slot
                </button>
